...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("peer", "Review inbound agent-to-agent (A2A) peer requests",
               "Tools & Skills", args_hint="[pending|approve|deny|status] [id]",
               subcommands=("pending", "approve", "deny", "status")),
