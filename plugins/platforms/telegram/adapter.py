...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _register_handlers(self, app) -> None:
        ...
        # Keep the catch-all after the specific message handlers, including
        # when reconnecting rebuilds the application.
        app.add_handler(TelegramMessageHandler(
            filters.ALL,
    ...
    async def send_voice(
        ...
        **kwargs,
        ...
        try:
            ...
            # Voice privacy settings can reject valid audio. Deliver the file
            # as a document before falling back to a text-only failure notice.
            try:
                return await self.send_document(
                    chat_id=chat_id,
                    file_path=audio_path,
                ...
                logger.error(
                    "[%s] Document fallback also failed: %s",
                    self.name,
